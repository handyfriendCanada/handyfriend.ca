...
export default function Discount() {
  ...
  return (
    <div className="fixed z-[999] bottom-0 left-[50%] -translate-x-[50%] w-[100%] isolate flex items-center gap-x-6 overflow-hidden bg-gray-50 px-3 md:px-6 py-3.5 sm:px-3.5 sm:before:flex-1">
      <div
        aria-hidden="true"
      ...
      <div className="flex flex-wrap items-center gap-x-4 gap-y-2">
        <p className="text-sm leading-6 text-gray-900 mx-auto text-center">
