          ...
          <Dialog static open={isOpen} onClose={() => setIsOpen(false)}>
            ...
            <div className='fixed z-10 top-0 left-0 flex w-screen'>
              ...
              <DialogPanel
                ...
                className='transition duration-100 ease-out max-w-[267px] xs:max-w-[323px] w-full h-screen space-y-4 bg-white p-5 flex flex-col gap-5 [@media_(max-height:600px)]:overflow-auto'>
        ...
        <div className='px-5 flex justify-center'>
          <div className='max-w-screen-container w-full py-[28px] flex justify-between'>
            <div className='flex items-center gap-16'>
              ...
              <div className='text-black flex items-center gap-[70px]'>
