  ...
  return (
    <div className='px-5 pt-[65px] pb-[45px] lg:pb-[85px] flex justify-center bg-main'>
      <div className='max-w-screen-container w-full flex flex-col xl:flex-row gap-8 justify-between items-center'>
        <div className='text-left lg:text-center xl:text-left flex flex-col gap-4 sm:gap-0'>
          <h4 className='max-w-[1120px] text-black text-3xl sm:text-[44px] font-semibold leading-[30px] sm:leading-[67px]'>
