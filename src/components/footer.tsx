  ...
  return (
    <footer className='bg-transparent'>
      <div className='bg-blue flex justify-center'>
        <div className='max-w-[1600px] w-full py-7 flex justify-center'>
          <div className='flex flex-col items-center gap-12'>
            <ButtonScroolToTop />
            <div className='lg:pl-20 flex items-center flex-col lg:flex-row justify-between gap-4 lg:gap-36'>
              <a
                className='cursor-pointer'
                target='_blank'
                href='https://maps.app.goo.gl/WUn9pMQ6eR4fBv7N8'>
                <InfoItem icon={<Image alt='map' src={MapIcon} />} text='M6P 2S3 Toronto' />
              </a>
              <button onClick={() => navigator.clipboard.writeText('+1 6478289633')}>
                <InfoItem icon={<Image alt='phone' src={PhoneIcon} />} text='+1 6478289633' />
              </button>
