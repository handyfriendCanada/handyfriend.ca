      ...
      <div className="max-w-screen-container flex flex-col gap-8 sm:gap-14">
        ...
        <div className="flex flex-col md:flex-row items-start justify-center gap-1 sm:gap-6">
          <div className="flex-1 flex flex-col gap-1 sm:gap-4">
            ...
            >
              No job is too small for us – whether it&apos;s changing a
              hard-to-reach lightbulb, fixing a door knob, or working through a
              to-do list around your space.
            </AccordionItem>
            <AccordionItem
            ...
            >
              Our work scope is broad. However, we do not handle rewiring
              electrical systems, extensive plumbing, or structural repairs.
              <br />
              We specialize in smaller renovation projects like installations,
              repairs, mounting, tiling, painting, and installing drywall and
              storage systems. We also offer some landscaping services.
            </AccordionItem>
            <AccordionItem
            ...
            >
              Yes, we operate 24/7, 365 days a year. For services outside our
              regular business hours (8 AM - 6 PM, Mon-Fri) and on some
              holidays, we charge an additional fee.
            </AccordionItem>
            <AccordionItem
            ...
            >
              While we provide all necessary materials and supplies, we
              recommend that you purchase specific items like faucets, light
              fixtures, or curtain rods to ensure you get exactly what you want.
              Please consult with our specialist before purchasing to ensure
              compatibility.
            </AccordionItem>
            <AccordionItem
            ...
            >
              We only hire specialists with 5+ years of experience. All new hires undergo a comprehensive training program to ensure they can tackle any challenge. Additionally, they receive regular training every 3-6 months to upgrade their skills.
            </AccordionItem>
          </div>
          <div className="flex-1 flex flex-col gap-1 sm:gap-4">
            <AccordionItem
            ...
            >
              Absolutely! Our handymen come fully equipped with all the
              necessary tools to tackle any repair or installation you need.
            </AccordionItem>
            <AccordionItem
            ...
            >
              • Hourly rate: $99 for the first hour + $49 for each additional
              hour
              <br />• Project-based pricing: Get an online quote or an in-house
              estimate.
            </AccordionItem>
            <AccordionItem
            ...
            >
              One handyman will come for smaller to mid-sized jobs. Larger or
              more complex jobs may require additional handymen to complete the
              work.
            </AccordionItem>
            <AccordionItem
