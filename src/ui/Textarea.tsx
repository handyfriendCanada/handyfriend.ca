...
const Textarea = React.forwardRef<HTMLTextAreaElement, ITextarea>(
  (
    { label, placeholder, type, id, name, className, onChange, error, value, disabled, onClear },
    ref,
  ) => {
      ...
      <div className={className}>
        ...
        <div className='flex flex-col-reverse gap-1'>
          <textarea
            ...
            id={identifier}
            className={cx(
              'pr-8 peer text-sm md:text-xl font-semibold text-[#455a64] resize-none p-4 rounded-[10px] border border-[#b0bec5] focus:border-black focus:text-dark shadow-sm block w-full focus:outline-none',
              {
